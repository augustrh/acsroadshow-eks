# ACS Roadshow EKS Environment Setup

echo "Setting up your AWS environment!"
...
# create an override for ACS Sensor to suit environment to be used with helm deployment
# you don't need this you can use larger instances but; but if you do need it it's here
